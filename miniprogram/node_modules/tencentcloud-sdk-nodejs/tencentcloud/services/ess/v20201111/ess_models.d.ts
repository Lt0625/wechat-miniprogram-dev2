 ...
 */
export interface ModifyPartnerAuthorizationResponse {
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface DescribeContractReviewTaskRequest {
    /**
     * 执行本接口操作的员工信息。
  注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
     */
 ...
 */
export interface CreateDraftContractByPromptsTaskRequest {
    /**
     * 执行本接口操作的员工信息。 注: 在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。
     */
    Operator: UserInfo;
 ...
 */
export interface CreateBatchContractReviewTaskResponse {
    /**
 ...
 */
export interface ExportContractReviewMarkedRiskResponse {
    /**
     * 导出任务 id。
     */
    TaskId?: string;
 ...
 */
export interface ExportContractReviewMarkedRiskRequest {
    /**
     * 执行本接口操作的员工信息。
  注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
     */
 ...
 * 第三方应用下企业用户信息
 */
export interface ProxyOrganizationInfo {
    /**
 ...
 */
export interface DescribeDraftContractByPromptsTaskRequest {
    /**
     * 执行本接口操作的员工信息。 注: 在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。
     */
    Operator: UserInfo;
