...
import { DescribeLogHistogramRequest, DescribeNetworkApplicationDetailRequest, DeleteShipperRequest, DeleteConsoleResponse, CreateRebuildIndexTaskResponse, CheckFunctionRequest, ModifyNetworkApplicationResponse, CreateLogsetRequest, CreateScheduledSqlResponse, CreateConsoleSharingRequest, SearchLogResponse, DeleteMetricSubscribeResponse, DescribePartitionsRequest, CheckFunctionResponse, ModifyAlarmResponse, PreviewKafkaRechargeRequest, CreateConfigExtraResponse, DescribeClusterBaseMetricConfigsRequest, DescribeConfigExtrasResponse, DeleteMetricSubscribeRequest, DeleteMachineGroupResponse, CreateDlcDeliverResponse, CreateConsumerGroupRequest, ModifyMachineGroupResponse, DescribeConsumerPreviewRequest, DeleteDashboardResponse, DeleteExportResponse, DescribeDashboardSubscribesRequest, CreateNoticeContentResponse, ModifyAlarmRequest, RetryShipperTaskResponse, SplitPartitionRequest, CreateAlarmShieldRequest, DeleteAlarmShieldResponse, CreateIndexRequest, CreateConsoleResponse, CreateTopicRequest, ModifyDataTransformRequest, CreateDlcDeliverRequest, ModifyScheduledSqlRequest, DeleteConfigResponse, CreateDeliverCloudFunctionRequest, ModifyDlcDeliverResponse, ModifyDashboardResponse, DescribeMetricSubscribesResponse, CreateWebCallbackRequest, DescribeClusterMetricConfigsRequest, DescribeConfigsRequest, DescribeKafkaConsumerTopicsResponse, QueryMetricRequest, DescribeAlarmNoticesResponse, DeleteDataTransformRequest, AddMachineGroupInfoRequest, DescribeKafkaConsumerGroupListResponse, CreateHostMetricConfigResponse, ModifyConsumerGroupRequest, CreateTopicResponse, DeleteAlarmResponse, DeleteConsoleSharingResponse, DescribeTopicBaseMetricConfigsRequest, DescribeDlcDeliversResponse, ModifyIndexRequest, GetAlarmLogRequest, DeleteCosRechargeResponse, DeleteTopicRequest, ModifyShipperRequest, DescribeKafkaConsumerPreviewRequest, CreateDeliverCloudFunctionResponse, DescribeDashboardsResponse, CreateConfigResponse, CreateCloudProductLogCollectionResponse, SearchCosRechargeInfoResponse, CreateEsRechargeResponse, ModifyMachineGroupRequest, DescribeHostMetricConfigsResponse, CreateNoticeContentRequest, CreateDashboardRequest, DeleteAlarmNoticeRequest, DescribeScheduledSqlInfoResponse, DescribeConsumersRequest, CreateMachineGroupRequest, DescribeExportsResponse, DescribeCloudProductLogTasksRequest, CreateAlarmNoticeRequest, DescribeTopicMetricConfigsRequest, ModifyLogsetRequest, SearchDashboardSubscribeResponse, ModifyCosRechargeRequest, DescribeClusterMetricConfigsResponse, DescribeWebCallbacksRequest, CreateMetricSubscribeResponse, DescribeMachinesRequest, DeleteSplunkDeliverResponse, DescribeTopicMetricConfigsResponse, DeleteDashboardSubscribeRequest, DeleteAlarmNoticeResponse, DeleteAlarmShieldRequest, ModifyEsRechargeRequest, CreateNetworkApplicationRequest, DeleteLogsetResponse, DeleteDlcDeliverResponse, DescribeShipperTasksResponse, DescribeAlarmShieldsResponse, ModifyConfigExtraResponse, DeleteConsoleSharingRequest, UploadLogRequest, ModifyConsoleSharingRequest, CommitConsumerOffsetsRequest, ModifyConsoleResponse, DescribeAlarmsRequest, DescribeShippersResponse, ModifyShipperResponse, GetMetricLabelValuesResponse, QueryMetricResponse, DeleteLogsetRequest, OpenKafkaConsumerResponse, CreateSplunkDeliverResponse, ModifyScheduledSqlResponse, QueryRangeMetricRequest, DescribeMachineGroupsRequest, DescribeConfigsResponse, DeleteDataTransformResponse, CreateConsumerResponse, DeleteMachineGroupRequest, DescribeSplunkDeliversResponse, SearchDashboardSubscribeRequest, DescribePartitionsResponse, ModifyHostMetricConfigResponse, DescribeMetricCorrectDimensionResponse, ModifyAlarmNoticeRequest, CreateAlarmRequest, DeleteScheduledSqlResponse, DescribeConsumersResponse, DescribeEsRechargesResponse, CheckRechargeKafkaServerRequest, DeleteDashboardSubscribeResponse, DescribeLogHistogramResponse, DescribeConsumerGroupsRequest, CreateWebCallbackResponse, DeleteConsumerGroupRequest, OpenKafkaConsumerRequest, CreateConsumerGroupResponse, ModifyMetricConfigResponse, DescribeConsumerResponse, DescribeNoticeContentsResponse, DescribeClusterBaseMetricConfigsResponse, CreateIndexResponse, ModifyDashboardSubscribeResponse, DescribeSplunkPreviewRequest, ModifyConfigRequest, CreateMetricConfigResponse, DeleteConfigFromMachineGroupResponse, PreviewKafkaRechargeResponse, DescribeAlarmsResponse, DeleteIndexResponse, DescribeSplunkDeliversRequest, DeleteScheduledSqlRequest, ModifyKafkaConsumerRequest, DescribeConsumerGroupsResponse, CreateDataTransformResponse, DescribeKafkaConsumerTopicsRequest, CreateConfigExtraRequest, CreateConsumerRequest, DeleteHostMetricConfigRequest, DeleteMetricConfigResponse, ApplyConfigToMachineGroupResponse, DeleteAlarmRequest, DescribeLogContextResponse, ModifyConsoleSharingResponse, EstimateRebuildIndexTaskResponse, DeleteDashboardRequest, CreateCosRechargeResponse, ModifyLogsetResponse, CreateDashboardResponse, GetMetricLabelValuesRequest, ModifyMetricSubscribeResponse, DescribeIndexResponse, DescribeConsumerPreviewResponse, DeleteMachineGroupInfoResponse, CheckRechargeKafkaServerResponse, DeleteNetworkApplicationResponse, DeleteNoticeContentRequest, DescribeKafkaConsumerRequest, ModifyDataTransformResponse, DescribeDataTransformInfoResponse, ModifyCosRechargeResponse, DescribeEsRechargePreviewRequest, MergePartitionResponse, CreateScheduledSqlRequest, DescribeKafkaConsumerGroupDetailResponse, ModifyDashboardRequest, SendConsumerHeartbeatResponse, DeleteHostMetricConfigResponse, DeleteMetricConfigRequest, CreateEsRechargeRequest, DescribeDashboardsRequest, DeleteNoticeContentResponse, DeleteCloudProductLogCollectionRequest, DescribeKafkaConsumerResponse, DeleteKafkaRechargeResponse, DeleteDlcDeliverRequest, ModifyNetworkApplicationRequest, DescribeHostMetricConfigsRequest, SplitPartitionResponse, DescribeConsoleSharingListResponse, CreateLogsetResponse, ModifyHostMetricConfigRequest, ModifyAlarmShieldResponse, CreateCosRechargeRequest, ChatCompletionsResponse, EstimateRebuildIndexTaskRequest, CreateAlarmShieldResponse, DescribeConsumerRequest, DeleteConfigExtraResponse, ModifyConsumerRequest, ModifyMetricConfigRequest, ModifyDashboardSubscribeRequest, CreateDashboardSubscribeRequest, DescribeConfigMachineGroupsResponse, ModifySplunkDeliverRequest, CreateMetricSubscribeRequest, DescribeConfigMachineGroupsRequest, DescribeMetricSubscribePreviewRequest, DeleteConsumerResponse, DescribeTopicsRequest, ModifySplunkDeliverResponse, RetryShipperTaskRequest, DeleteCosRechargeRequest, CreateHostMetricConfigRequest, ModifyWebCallbackResponse, ModifyCloudProductLogCollectionResponse, DeleteConsumerRequest, CreateNetworkApplicationResponse, DeleteIndexRequest, DescribeAlertRecordHistoryRequest, ChatCompletionsRequest, DeleteNetworkApplicationRequest, CreateExportRequest, CancelRebuildIndexTaskRequest, DescribeConsoleSharingListRequest, DescribeLogsetsResponse, DescribeKafkaConsumerPreviewResponse, CreateAlarmNoticeResponse, ModifyTopicResponse, CreateConfigRequest, DeleteEsRechargeResponse, DescribeNetworkApplicationsRequest, DescribeKafkaRechargesResponse, ModifyDlcDeliverRequest, DeleteCloudProductLogCollectionResponse, DescribeWebCallbacksResponse, DeleteExportRequest, ModifyKafkaConsumerGroupOffsetRequest, DescribeConsolesRequest, ModifyConfigResponse, ModifyConsoleRequest, DescribeRebuildIndexTasksResponse, ModifyAlarmNoticeResponse, DescribeConsumerOffsetsResponse, CreateConsoleSharingResponse, ModifyKafkaConsumerResponse, DescribeAlertRecordHistoryResponse, DescribeEsRechargesRequest, DescribeAlarmNoticesRequest, DescribeEsRechargePreviewResponse, MergePartitionRequest, ApplyConfigToMachineGroupRequest, DescribeMachineGroupConfigsResponse, DescribeConfigExtrasRequest, DescribeMachineGroupConfigsRequest, ModifyKafkaRechargeRequest, ModifyWebCallbackRequest, DeleteTopicResponse, CreateExportResponse, CancelRebuildIndexTaskResponse, UploadLogResponse, CreateAlarmResponse, DescribeMetricSubscribesRequest, DescribeLogContextRequest, DescribeMetricCorrectDimensionRequest, DescribeCosRechargesResponse, CreateSplunkDeliverRequest, CreateMachineGroupResponse, OpenClawServiceRequest, SearchCosRechargeInfoRequest, DescribeNoticeContentsRequest, DescribeDlcDeliversRequest, DescribeNetworkApplicationDetailResponse, DescribeShipperTasksRequest, CreateCloudProductLogCollectionRequest, DescribeIndexRequest, DescribeKafkaConsumerGroupListRequest, CreateConsoleRequest, DeleteMachineGroupInfoRequest, ModifyNoticeContentResponse, DeleteWebCallbackResponse, ModifyKafkaRechargeResponse, DescribeAlarmShieldsRequest, DescribeTopicsResponse, DescribeRebuildIndexTasksRequest, DescribeShippersRequest, DescribeCloudProductLogTasksResponse, DescribeCosRechargesRequest, DescribeNetworkApplicationsResponse, DescribeTopicBaseMetricConfigsResponse, CloseKafkaConsumerResponse, GetAlarmLogResponse, DescribeKafkaRechargesRequest, CreateDashboardSubscribeResponse, DescribeExportsRequest, CreateKafkaRechargeResponse, ModifyIndexResponse, QueryRangeMetricResponse, DescribeDashboardSubscribesResponse, CreateMetricConfigRequest, ModifyConsumerResponse, DeleteConfigRequest, DeleteWebCallbackRequest, CloseKafkaConsumerRequest, ModifyAlarmShieldRequest, DeleteConfigExtraRequest, ModifyKafkaConsumerGroupOffsetResponse, CreateShipperRequest, CreateShipperResponse, ModifyCloudProductLogCollectionRequest, OpenClawServiceResponse, DescribeDataTransformInfoRequest, CreateRebuildIndexTaskRequest, DeleteShipperResponse, ModifyTopicRequest, DeleteSplunkDeliverRequest, ModifyEsRechargeResponse, ModifyConsumerGroupResponse, CreateKafkaRechargeRequest, DeleteKafkaRechargeRequest, ModifyNoticeContentRequest, DescribeMachinesResponse, DeleteEsRechargeRequest, ModifyMetricSubscribeRequest, DeleteConfigFromMachineGroupRequest, AddMachineGroupInfoResponse, DescribeMetricSubscribePreviewResponse, DescribeScheduledSqlInfoRequest, DeleteConsumerGroupResponse, SearchLogRequest, DescribeKafkaConsumerGroupDetailRequest, DescribeConsumerOffsetsRequest, DeleteConsoleRequest, ModifyConfigExtraRequest, CreateDataTransformRequest, DescribeMachineGroupsResponse, DescribeLogsetsRequest, DescribeConsolesResponse, SendConsumerHeartbeatRequest, CommitConsumerOffsetsResponse, DescribeSplunkPreviewResponse } from "./cls_models";
/**
 * cls client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    OpenClawService(req: OpenClawServiceRequest, cb?: (error: string, rep: OpenClawServiceResponse) => void): Promise<OpenClawServiceResponse>;
    /**
     * 本接口用于获取日志下载任务列表
     */
     ...
     * 修改网络应用
     */
    ModifyNetworkApplication(req: ModifyNetworkApplicationRequest, cb?: (error: string, rep: ModifyNetworkApplicationResponse) => void): Promise<ModifyNetworkApplicationResponse>;
    /**
     * 修改主机指标采集配置
     */
    ModifyHostMetricConfig(req: ModifyHostMetricConfigRequest, cb?: (error: string, rep: ModifyHostMetricConfigResponse) => void): Promise<ModifyHostMetricConfigResponse>;
    /**
     * 本接口用于获取告警策略执行详情
     */
...
如果该时刻向前推5分钟内均无指标数据，则无相应的查询结果。
     ...
     * 获取网络应用列表
     */
    DescribeNetworkApplications(req: DescribeNetworkApplicationsRequest, cb?: (error: string, rep: DescribeNetworkApplicationsResponse) => void): Promise<DescribeNetworkApplicationsResponse>;
    /**
     * 获取es导入配置
     */
    DescribeEsRecharges(req: DescribeEsRechargesRequest, cb?: (error: string, rep: DescribeEsRechargesResponse) => void): Promise<DescribeEsRechargesResponse>;
    /**
     * 本接口用于创建日志或指标主题。
     */
     ...
     * 获取指标订阅配置
     */
    DescribeHostMetricConfigs(req: DescribeHostMetricConfigsRequest, cb?: (error: string, rep: DescribeHostMetricConfigsResponse) => void): Promise<DescribeHostMetricConfigsResponse>;
    /**
     * 创建指标订阅配置
     */
    CreateMetricSubscribe(req: CreateMetricSubscribeRequest, cb?: (error: string, rep: CreateMetricSubscribeResponse) => void): Promise<CreateMetricSubscribeResponse>;
    /**
     * kafka协议消费预览接口
     */
    DescribeKafkaConsumerPreview(req?: DescribeKafkaConsumerPreviewRequest, cb?: (error: string, rep: DescribeKafkaConsumerPreviewResponse) => void): Promise<DescribeKafkaConsumerPreviewResponse>;
    /**
     * 获取指标订阅配置
     */
    DescribeClusterMetricConfigs(req: DescribeClusterMetricConfigsRequest, cb?: (error: string, rep: DescribeClusterMetricConfigsResponse) => void): Promise<DescribeClusterMetricConfigsResponse>;
    /**
     * 获取告警历史，例如今天未恢复的告警
     */
     ...
     * splunk投递任务预览
     */
    DescribeSplunkPreview(req: DescribeSplunkPreviewRequest, cb?: (error: string, rep: DescribeSplunkPreviewResponse) => void): Promise<DescribeSplunkPreviewResponse>;
    /**
     * 内部云产品接入使用相关接口
     */
     ...
     * 删除主机指标采集配置
     */
    DeleteHostMetricConfig(req: DeleteHostMetricConfigRequest, cb?: (error: string, rep: DeleteHostMetricConfigResponse) => void): Promise<DeleteHostMetricConfigResponse>;
    /**
     * 本接口用于删除定时SQL分析任务
     */
     ...
     * 删除Splunk投递任务
     */
    DeleteSplunkDeliver(req: DeleteSplunkDeliverRequest, cb?: (error: string, rep: DeleteSplunkDeliverResponse) => void): Promise<DeleteSplunkDeliverResponse>;
    /**
     * 查询DataSight控制台实例列表
     */
    DescribeConsoles(req: DescribeConsolesRequest, cb?: (error: string, rep: DescribeConsolesResponse) => void): Promise<DescribeConsolesResponse>;
    /**
     * 获取消费组点位信息
     */
    DescribeConsumerOffsets(req: DescribeConsumerOffsetsRequest, cb?: (error: string, rep: DescribeConsumerOffsetsResponse) => void): Promise<DescribeConsumerOffsetsResponse>;
    /**
     * 获取网络应用详情
     */
    DescribeNetworkApplicationDetail(req: DescribeNetworkApplicationDetailRequest, cb?: (error: string, rep: DescribeNetworkApplicationDetailResponse) => void): Promise<DescribeNetworkApplicationDetailResponse>;
    /**
     * 获取指标订阅配置
     */
    DescribeTopicMetricConfigs(req: DescribeTopicMetricConfigsRequest, cb?: (error: string, rep: DescribeTopicMetricConfigsResponse) => void): Promise<DescribeTopicMetricConfigsResponse>;
    /**
     * 修改指标订阅配置
     */
    ModifyMetricSubscribe(req: ModifyMetricSubscribeRequest, cb?: (error: string, rep: ModifyMetricSubscribeResponse) => void): Promise<ModifyMetricSubscribeResponse>;
    /**
     * 创建DLC投递任务
     */
     ...
     * 删除指标订阅配置
     */
    DeleteMetricSubscribe(req: DeleteMetricSubscribeRequest, cb?: (error: string, rep: DeleteMetricSubscribeResponse) => void): Promise<DeleteMetricSubscribeResponse>;
    /**
     * 创建es导入配置
     */
    CreateEsRecharge(req: CreateEsRechargeRequest, cb?: (error: string, rep: CreateEsRechargeResponse) => void): Promise<CreateEsRechargeResponse>;
    /**
     * 修改es导入配置
     */
    ModifyEsRecharge(req: ModifyEsRechargeRequest, cb?: (error: string, rep: ModifyEsRechargeResponse) => void): Promise<ModifyEsRechargeResponse>;
    /**
     * 删除DLC投递任务
     */
     ...
     * es导入预览
     */
    DescribeEsRechargePreview(req: DescribeEsRechargePreviewRequest, cb?: (error: string, rep: DescribeEsRechargePreviewResponse) => void): Promise<DescribeEsRechargePreviewResponse>;
    /**
     ...
     * 本接口用于kafka投递数据预览
     */
    DescribeConsumerPreview(req?: DescribeConsumerPreviewRequest, cb?: (error: string, rep: DescribeConsumerPreviewResponse) => void): Promise<DescribeConsumerPreviewResponse>;
    /**
     * 删除机器组
     */
     ...
     * 删除es导入配置
     */
    DeleteEsRecharge(req: DeleteEsRechargeRequest, cb?: (error: string, rep: DeleteEsRechargeResponse) => void): Promise<DeleteEsRechargeResponse>;
    /**
     * 消费组心跳
     */
    SendConsumerHeartbeat(req: SendConsumerHeartbeatRequest, cb?: (error: string, rep: SendConsumerHeartbeatResponse) => void): Promise<SendConsumerHeartbeatResponse>;
    /**
     * 本接口用于删除cos导入任务
     */
    DeleteCosRecharge(req: DeleteCosRechargeRequest, cb?: (error: string, rep: DeleteCosRechargeResponse) => void): Promise<DeleteCosRechargeResponse>;
    /**
     * 获取Kafka协议消费组信息列表
     */
    DescribeKafkaConsumerGroupList(req: DescribeKafkaConsumerGroupListRequest, cb?: (error: string, rep: DescribeKafkaConsumerGroupListResponse) => void): Promise<DescribeKafkaConsumerGroupListResponse>;
    /**
     * 修改splunk投递任务相关信息
     */
    ModifySplunkDeliver(req: ModifySplunkDeliverRequest, cb?: (error: string, rep: ModifySplunkDeliverResponse) => void): Promise<ModifySplunkDeliverResponse>;
    /**
     * 本接口用于获取Kafka数据订阅任务
     */
     ...
     * 获取指标订阅配置
     */
    DescribeMetricCorrectDimension(req?: DescribeMetricCorrectDimensionRequest, cb?: (error: string, rep: DescribeMetricCorrectDimensionResponse) => void): Promise<DescribeMetricCorrectDimensionResponse>;
    /**
     * 本接口用于构建日志数量直方图
     */
     ...
     * 创建网络应用
     */
    CreateNetworkApplication(req: CreateNetworkApplicationRequest, cb?: (error: string, rep: CreateNetworkApplicationResponse) => void): Promise<CreateNetworkApplicationResponse>;
    /**
     * 该接口用于删除告警渠道回调配置。
     */
     ...
     * 获取指标订阅配置
     */
    DescribeClusterBaseMetricConfigs(req: DescribeClusterBaseMetricConfigsRequest, cb?: (error: string, rep: DescribeClusterBaseMetricConfigsResponse) => void): Promise<DescribeClusterBaseMetricConfigsResponse>;
    /**
     * 此接口用于预览仪表盘订阅
     */
     ...
     * 提交消费点位
     */
    CommitConsumerOffsets(req: CommitConsumerOffsetsRequest, cb?: (error: string, rep: CommitConsumerOffsetsResponse) => void): Promise<CommitConsumerOffsetsResponse>;
    /**
     * 创建控制台分享
     */
     ...
     * 本接口用于删除DataSight控制台
     */
    DeleteConsole(req: DeleteConsoleRequest, cb?: (error: string, rep: DeleteConsoleResponse) => void): Promise<DeleteConsoleResponse>;
    /**
     * 获取告警渠道回调配置列表。
     */
     ...
     * 获取Splunk投递任务列表
     */
    DescribeSplunkDelivers(req: DescribeSplunkDeliversRequest, cb?: (error: string, rep: DescribeSplunkDeliversResponse) => void): Promise<DescribeSplunkDeliversResponse>;
    /**
...
- 重建索引时间范围以日志时间为准，日志上传时间与重建索引时间范围有超过1小时的偏差时（例如16:00上传了一条02:00的日志到 CLS，重建00:00～12:00的日志索引）不会被重建且后续无法进行检索。新上报一条日志到已经被重建的日志时间范围时，也不会被重建且后续无法进行检索。
     ...
     * 删除指标采集配置
     */
    DeleteMetricConfig(req: DeleteMetricConfigRequest, cb?: (error: string, rep: DeleteMetricConfigResponse) => void): Promise<DeleteMetricConfigResponse>;
    /**
     * 创建Splunk投递任务
     */
    CreateSplunkDeliver(req: CreateSplunkDeliverRequest, cb?: (error: string, rep: CreateSplunkDeliverResponse) => void): Promise<CreateSplunkDeliverResponse>;
    /**
     * 本接口用于创建数据加工任务。
     */
     ...
     * 本接口用于编辑DataSight控制台
     */
    ModifyConsole(req: ModifyConsoleRequest, cb?: (error: string, rep: ModifyConsoleResponse) => void): Promise<ModifyConsoleResponse>;
    /**
...
⚠️注意：通过SSE流式调用此接口时，请务必设置请求域名（Endpoint）为 cls.ai.tencentcloudapi.com (VPC内网环境可配置 cls.ai.internal.tencentcloudapi.com）。
     ...
     * 创建指标订阅配置
     */
    DescribeMetricSubscribePreview(req: DescribeMetricSubscribePreviewRequest, cb?: (error: string, rep: DescribeMetricSubscribePreviewResponse) => void): Promise<DescribeMetricSubscribePreviewResponse>;
    /**
     * 本接口用于修改日志或指标主题。
     */
...
注意：修改接口直接覆盖历史数据，改为本次合法入参数据，请谨慎调用此接口。
     ...
     */
    DescribeKafkaConsumerTopics(req?: DescribeKafkaConsumerTopicsRequest, cb?: (error: string, rep: DescribeKafkaConsumerTopicsResponse) => void): Promise<DescribeKafkaConsumerTopicsResponse>;
    /**
     * 获取消费组列表
     */
     ...
     * 修改Kafka协议消费组点位
     */
    ModifyKafkaConsumerGroupOffset(req?: ModifyKafkaConsumerGroupOffsetRequest, cb?: (error: string, rep: ModifyKafkaConsumerGroupOffsetResponse) => void): Promise<ModifyKafkaConsumerGroupOffsetResponse>;
    /**
     * 修改控制台分享，目前仅允许修改有效期
     */
     ...
     * 获取指标订阅配置
     */
    DescribeMetricSubscribes(req: DescribeMetricSubscribesRequest, cb?: (error: string, rep: DescribeMetricSubscribesResponse) => void): Promise<DescribeMetricSubscribesResponse>;
    /**
     * 获取时序label values列表
     */
    GetMetricLabelValues(req: GetMetricLabelValuesRequest, cb?: (error: string, rep: GetMetricLabelValuesResponse) => void): Promise<GetMetricLabelValuesResponse>;
    /**
     * 获取投递规则信息列表
     */
    DescribeConsumers(req: DescribeConsumersRequest, cb?: (error: string, rep: DescribeConsumersResponse) => void): Promise<DescribeConsumersResponse>;
    /**
     * 删除网络应用
     */
    DeleteNetworkApplication(req: DeleteNetworkApplicationRequest, cb?: (error: string, rep: DeleteNetworkApplicationResponse) => void): Promise<DeleteNetworkApplicationResponse>;
    /**
     * 获取Kafka协议消费组详情
     */
    DescribeKafkaConsumerGroupDetail(req: DescribeKafkaConsumerGroupDetailRequest, cb?: (error: string, rep: DescribeKafkaConsumerGroupDetailResponse) => void): Promise<DescribeKafkaConsumerGroupDetailResponse>;
    /**
     * 本接口用于获取仪表盘
     */
...
将生成的 cls.pb.h 头文件引入代码中，调用接口进行数据格式封装。
     ...
     * 本接口用于创建DataSight控制台
     */
    CreateConsole(req: CreateConsoleRequest, cb?: (error: string, rep: CreateConsoleResponse) => void): Promise<CreateConsoleResponse>;
    /**
     * 本接口用于删除告警策略。
     */
...
API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 创建指标采集配置
     */
    CreateMetricConfig(req: CreateMetricConfigRequest, cb?: (error: string, rep: CreateMetricConfigResponse) => void): Promise<CreateMetricConfigResponse>;
    /**
     * 获取通知内容列表
     */
     ...
     * 创建指标采集配置
     */
    ModifyMetricConfig(req: ModifyMetricConfigRequest, cb?: (error: string, rep: ModifyMetricConfigResponse) => void): Promise<ModifyMetricConfigResponse>;
    /**
     * 获取指定机器组下的机器状态
     */
