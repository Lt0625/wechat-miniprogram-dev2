...
export interface AddOnParameter {
     ...
     * 附加图片输入。
     */
    ImageSet?: Array<AddOnImageInput>;
    /**
     * 图片处理输出配置。
     */
...
export interface SmartSubtitleTaskTextResultOutput {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    RecognizeSubtitleResult?: Array<SubtitleResult>;
    /**
     * <p>翻译字幕结果</p>
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TransSubtitleResult?: Array<SubtitleResult>;
    /**
     * <p>字幕文件存储位置</p>
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface RecognizeAudioResponse {
    /**
     * 整段音频的识别结果
     */
    Text?: string;
     ...
     * 分句的识别结果
     */
    Sentence?: Array<RecognizeAudioSentence>;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 * 字幕翻译输出结果
 */
export interface SubtitleTransResultItem {
    /**
 ...
 * 字幕压制模块背景配置
 */
export interface SubtitleBoardConfig {
    /**
...
export interface EvaluationTaskInput {
     ...
     */
    EvaluationTypeSet: Array<string>;
    /**
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     * @deprecated
     */
    ContrastInfoSet?: Array<MediaInputInfo>;
    /**
     * 对比视频信息。
     */
    ContrastMediaSet?: Array<EvaluationMediaInputInfo>;
    /**
     * 对比转码模板信息。
     */
    ContrastTemplateSet?: Array<EvaluationTemplateInputInfo>;
    /**
     ...
     */
    BitrateSet?: Array<number | bigint>;
    /**
     * 指定 vcrf 评测，当评测任务类型为 BD_RATE 有效。
     */
    VCRFSet?: Array<number | bigint>;
}
/**
 * 查询输入的RTMP配置信息。
 */
...
export interface Rules {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    Conditions?: Array<RuleConditionItem>;
    /**
     * 条件列表的链接符号，取值如下：
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    RearDriveIndexs?: Array<number | bigint>;
}
/**
 * 文本关键识别结果。
 */
 ...
 * 条件判断输出
 */
export interface ExecRuleTaskData {
    /**
     * 质检条件判断需要执行的节点索引。
     */
 ...
 */
export interface DescribeSubtitleEmbedTemplatesResponse {
    /**
     * <p>符合过滤条件的记录总数。</p>
     */
    TotalCount?: number;
     ...
     * <p>字幕压制模板详情列表。</p>
     */
    SubtitleEmbedTemplateSet?: Array<SubtitleEmbedTemplateItem>;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 * 智能字幕全文识别结果。
 */
export interface SmartSubtitleTaskFullTextResult {
    /**
     * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
     */
    Status?: string;
...
/**
 * CreateSubtitleEmbedTemplate返回参数结构体
 */
export interface CreateSubtitleEmbedTemplateResponse {
    /**
     * <p>字幕压制模板唯一标识。</p>
     */
    Definition?: number;
 ...
 * 用于AIGC视频生成的参考视频素材。
 */
export interface AigcVideoReferenceVideoInfo {
    /**
     * 参考视频url。需要外网可访问。
 ...
 * SyncDubbing返回参数结构体
 */
export interface SyncDubbingResponse {
    /**
     * <p>错误码，成功时返回0</p>
     */
    ErrorCode?: number;
 ...
 * 字幕压制模块配置
 */
export interface SubtitleEmbedConfig {
    /**
 ...
 * 新插帧配置，支持分数帧率
 */
export interface FrameRateWithDenConfig {
    /**
     * 能力配置开关，可选值：
  <li>ON：开启；</li>
  <li>OFF：关闭。</li>
 ...
 * 大模型增强
 */
export interface DiffusionEnhanceConfig {
    /**
     * 能力配置开关，可选值：
 ...
 */
export interface CreateSubtitleEmbedTemplateRequest {
    /**
 ...
 * 图片处理编排输出配置。
 */
export interface ImageProcessOutputConfig {
    /**
 ...
 * 字幕压制模板详情
 */
export interface SubtitleEmbedTemplateItem {
    /**
     * 字幕压制模板唯一标识
     */
    Definition?: number;
 ...
 */
export interface RecognizeAudioRequest {
    /**
     * base64编码的音频数据
     */
    AudioData: string;
